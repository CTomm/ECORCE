...
function keepresults(){
  ...
  //On divise pour passer en équivalent KWh
  var energie = parseFloat(document.getElementById("Q9-A").value)*12 + parseFloat(document.getElementById("Q9-B").value)/0.2453 +parseFloat(document.getElementById("Q9-C").value)/1.5+parseFloat(document.getElementById("Q9-D").value)/0.666;
